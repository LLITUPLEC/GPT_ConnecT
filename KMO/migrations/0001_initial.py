    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('idprofile', models.ForeignKey(default=None, null=True, on_delete=django.db.models.deletion.CASCADE, to='Main.profile', verbose_name='Член комиссии')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('RW_thread', models.CharField(choices=[('r', 'правая'), ('l', 'левая')], max_length=2, verbose_name='Нитка')),
                ...
                ('image_defect', models.ImageField(blank=True, upload_to='kmo_imgs', verbose_name='Фотография неисправности')),
                ('eliminated', models.BooleanField(default=False, verbose_name='Устранено')),
                ...
                ('idrwsp', models.ForeignKey(blank=True, default=None, null=True, on_delete=django.db.models.deletion.CASCADE, to='BS.bs_rwsp', verbose_name='Стрелочный перевод')),
                ...
                ('idrwway', models.ForeignKey(blank=True, default=None, null=True, on_delete=django.db.models.deletion.CASCADE, to='BS.bs_rwway', verbose_name='Путь')),
            ],
            options={
